...
public class LineBotController {
    ...
    private void handleTextContent(String replyToken, Event event, TextMessageContent content) {
        ...
        switch (text) {
            ...
            case "วิธีทำตำเตา" : {
                this.reply(replyToken, new Food5Pv1().get());
                break;
            }
            case "วิธีทำหลู้หมู" : {
                this.reply(replyToken, new Food5Pv2().get());
                break;
            }
            case "วิธีทำน้ำพริกอ่อง" : {
                this.reply(replyToken, new Food5Pv3().get());
                break;
            }
            case "วิธีทำขนมจีนน้ำหมู" : {
                this.reply(replyToken, new Food5Pv4().get());
                break;
            }
            ...
            case "วิธีทำแกงฮังเล": {
                this.reply(replyToken, new Food6Pv1().get());
                break;
            }
            case ";วิธีทำข่างปอง": {
                this.reply(replyToken, new Food6Pv2().get());
                break;
            }
            case "วิธีทำถั่วเน่าเมอะ": {
                this.reply(replyToken, new Food6Pv3().get());
                break;
            }
            case "วิธีทำจอผักกาด": {
                this.reply(replyToken, new Food6Pv4().get());
                break;
            }
            ...
            case "วิธีทำลาบลำปาง": {
                this.reply(replyToken, new Food7Pv1().get());
                break;
            }
